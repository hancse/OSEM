...
#define MW_BOARDPARAMETERS_DEVICEADDRESS 169.254.112.93
#define MW_BOARDPARAMETERS_USERNAME pi
#define MW_BOARDPARAMETERS_PASSWORD OSEM
...
#define MW_MQTT_BROKERADDRESS 192.168.4.1
#define MW_MQTT_USERNAME SIOM_network
#define MW_MQTT_PASSWORD [q<9LGSy4[
