###########################################################################
## Makefile generated for component 'emul_flow_sens'. 
## 
## Makefile     : emul_flow_sens.mk
## Generated on : Thu Aug 11 13:24:35 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/emul_flow_sens.elf
...
PRODUCT_NAME              = emul_flow_sens
MAKEFILE                  = emul_flow_sens.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2020b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2020b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/Triphase_Setup/Documents/GitHub/OSEM/MATLAB_MPC/Sensor_Actuator_Test_program
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH        = C:/Users/TRIPHA~1/DOCUME~1/MATLAB/R2020b/ARDUIN~1/ARDUIN~2/FASTER~1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/emul_flow_sens.elf
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DMW_TIMERID=1 -DMW_PRESCALAR=64 -DMW_TIMERCOUNT=65286 -DMW_SCHEDULERCOUNTER=1 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=emul_flow_sens -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_arduino_digitalio.o emul_flow_sens.o emul_flow_sens_data.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/emul_flow_sens_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/emul_flow_sens_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/emul_flow_sens_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
emul_flow_sens.o : $(START_DIR)/emul_flow_sens_ert_rtw/emul_flow_sens.c
	$(CC) $(CFLAGS) -o "$@" "$<"


emul_flow_sens_data.o : $(START_DIR)/emul_flow_sens_ert_rtw/emul_flow_sens_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/emul_flow_sens_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
