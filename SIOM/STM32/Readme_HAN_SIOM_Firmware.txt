...
- Register map:
	...
	- REG_OUTPUT = 0x01		output register
		Data format (12 bytes)
			1.	Temperature sensor 1 (Valid value -55 - 125) >> 1 byte (value is send as uint8 >> value is always +55 degrees, example 0 degree celcius results in value 55)
			2.	Temperature sensor 2 (Valid value -55 - 125) >> 1 byte (value is send as uint8 >> value is always +55 degrees, example 0 degree celcius results in value 55)
			3.	Temperature sensor 3 Valid value -55 - 125) >> 1 byte (value is send as uint8 >> value is always +55 degrees, example 0 degree celcius results in value 55)
			4.	Temperature sensor 4 Valid value -55 - 125) >> 1 byte (value is send as uint8 >> value is always +55 degrees, example 0 degree celcius results in value 55)
			5.	Temperature sensor 5 Valid value -55 - 125) >> 1 byte (value is send as uint8 >> value is always +55 degrees, example 0 degree celcius results in value 55)
			6.	Temperature sensor 6 Valid value -55 - 125) >> 1 byte (value is send as uint8 >> value is always +55 degrees, example 0 degree celcius results in value 55)
			7.	Temperature sensor 7 Valid value -55 - 125) >> 1 byte (value is send as uint8 >> value is always +55 degrees, example 0 degree celcius results in value 55)
			8.	Temperature sensor 8 Valid value -55 - 125) >> 1 byte (value is send as uint8 >> value is always +55 degrees, example 0 degree celcius results in value 55)
